...
// 	tokenize map[string]AutoCompleteTokenizer
...
// 	analyze map[string]AutoComplete
...
type Analysis struct {
	...
	AnalysisAnalyzer   map[string]AutoComplete          `json:"analyzer"`
	AnalysisTokenizer  map[string]AutoCompleteTokenizer `json:"tokenizer"`
}
...
func main() {
	...
	json.Unmarshal(byteValue, &comp.mp)
	fmt.Println(comp.mp["comp-7-s-2021.11.23"].CompSetting.IndexNum.IndexAnalysis.AnalysisTokenizer["autocomplete_version_number_tokenizer"])
	// fmt.Println(res["comp-7-s-2021.11.23"])
